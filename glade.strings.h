...
gchar *s = N_("_KDCs");
gchar *s = N_("*");
gchar *s = N_("Use _DNS to resolve hosts to realms");
gchar *s = N_("Use DNS to _locate KDCs for realms");
...
gchar *s = N_("*");
gchar *s = N_("Winbind Domain Co_ntrollers");
gchar *s = N_("*");
gchar *s = N_("_Template Shell");
